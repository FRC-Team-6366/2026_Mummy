...
public class Intake extends SubsystemBase{
    ...
    /**
     * Sets intake pivot motor to a certain angle based on what we put in to the double
    ...
    /**
     * Returns whether the Intake Pivot Motor is at its set point distance, given a percent of tolerence
     * specified in the IntakeIO hardware class
     * @return BooleanSupplier: True Intake Pivot Motor is at its setpoint, false otherwise
     */

...
public interface IntakeIO {
        /**
     * Gets the current number of rotations of the intake pivot motor from its starting
     * position
     * <p>
     * <b>NOTE: Move the hood to fully restracted position before turning on the robot!</b>
     * @return Rotation2d object representing the number of rotations of the intake pivot motor
     */
    ...
    /**
     * Gets the difference between the intake pivot motor's position (number of rotations) from its current setpoint
     * @return Error amount
     */

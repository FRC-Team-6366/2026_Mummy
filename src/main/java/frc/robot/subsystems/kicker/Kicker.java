...
public class Kicker extends SubsystemBase {
  ...
  /**
   * Creates Kicker subsystem by using the supplied KickerIO object that
   * represents
   ...
   * 
   * <pre>{@code
   * Kicker kicker = new Kicker(new KickerIOTalonFX());
   * }</pre>
   * 
   * @param io
   *          Hardware object that implements the KickerIO interface class
   * 
   */
   ...
   * 
   * <pre>{@code
   * controller.a().whileTrue(kicker.turnOnKicker());
   * }</pre>
   * 
   ...
   * 
   * <pre>{@code
   * controller.b().whileTrue(kicker.turnOffKicker());
   * }</pre>
   * 
